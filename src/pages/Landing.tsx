...
function Landing() {
    ...
    return (
        <div>
            <nav className="border-gray-200">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FORMS</span>
                    </a>

                    <div className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                        <button type="button" data-dropdown-toggle="language-dropdown-menu" className="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-full cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <div className="w-full overflow-hidden bg-lime-500 py-4">
                <div className="flex w-max animate-marquee space-x-8">
                    {[...Array(2)].map((_, i) => (
                        <span key={i} className="flex space-x-8">
                            {[...Array(30)].map((_, j) => (
                                <p key={j} className="text-stone-800 text-2xl font-bold">
                                    {text}
                                </p>
                            ))}
                        </span>
            ...
            <footer className="bg-stone-800 text-white">
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between text-white">
                        <div className="mb-6 md:mb-0">
                            <a href="https://flowbite.com/" className="flex items-center">
                                ...
                                <span className="self-center text-2xl font-semibold whitespace-nowrap">FORMS</span>
                            </a>
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                ...
                                <ul className="font-medium text-white">
                                    <li className="mb-4">
                                        <a href="https://flowbite.com/" className="hover:underline hover:text-lime-500">Home</a>
                                    </li>
                                    <li>
                                        <a href="https://tailwindcss.com/" className="hover:underline hover:text-lime-500">Start Forms</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="font-medium text-white">
                                    <li className="mb-4">
                                        <a href="#" className="hover:underline hover:text-lime-500">Github</a>
                                    </li>
                                    <li>
                                        <a href="#" className="hover:underline hover:text-lime-500">Discord</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="font-medium text-white">
                                    <li className="mb-4">
                                        <a href="#" className="hover:underline hover:text-lime-500">Privacy Policy</a>
                                    </li>
                                    <li>
                                        <a href="#" className="hover:underline hover:text-lime-500">Terms &amp; Conditions</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-white sm:text-center">© 2025 <a href="#" className="hover:underline">FORMS™</a>. All Rights Reserved.
                        </span>
                        <div className="flex mt-4 sm:justify-center sm:mt-0">
                            ...
                            <a href="#" className="text-white hover:text-lime-500 ms-5">
